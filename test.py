...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text='Currency Convertor',
        ...
        self.intro_label.place(x=140, y=50)
        self.date_label.place(x=110, y=100)
        ...
        # placing
        self.from_currency_dropdown.place(x=40, y=200)
        self.amount_field.place(x=20, y=240)
        self.to_currency_dropdown.place(x=340, y=200)
        # self.converted_amount_field.place(x = 346, y = 150)
        self.converted_amount_field_label.place(x=335, y=240)
